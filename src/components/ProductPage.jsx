...
const ProductPage = () => {
  ...
  const { productId, discountApplied, discountPercentage } =
    location.state || {};
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      ...
      try {
        ...
        const productData = response.data.items.find(
  ...
  const reviews = [
    ...
    },
    {
      ...
      date: "2 days ago",
      review:
        "Love my new sneakers! They look exactly like the photos and fit perfectly.",
    },
    {
      user: "Blade X",
      date: "2 days ago",
              ...
              <div className="col-span-1 md:col-span-1">
                ...
                <div className="mt-12">
                  ...
                  {reviews.map((review, index) => (
                    <div
                      key={index}
                      className="mb-4 p-4 rounded-lg shadow-md bg-gray-100"
                    >
              ...
              <div className="col-span-1 md:col-span-1 space-y-8">
                ...
                <div className="flex items-center">
                  {[...Array(5)].map((_, index) => (
                    <FaStar
                      key={index}
                      className={`text-yellow-400 ${index >= 4 ? "text-gray-300" : ""}`}
                    />
                  ))}
                ...
                <div>
                  {discountedPrice ? (
                    <>
                      ...
                      <span className="text-sm text-red-500 ml-2">50% OFF</span>
                    </>
                  ) : (
                ...
                <div className="mb-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {[40, 41, 42, 43, 44, 45, 46, "46.5", 47, 48, 49, 50].map(
                      (size, index) => (
                        <button
                          key={index}
